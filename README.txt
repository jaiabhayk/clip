...
2) Edit the vw_interface.py and change the variable "path_to_vw" to point to vw 
...
4) The Predictions.txt contains the actual score and the predicted score for each tweet in the test set.
